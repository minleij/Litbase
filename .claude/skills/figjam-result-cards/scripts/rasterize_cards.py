"""
Step 4 of the figjam-result-cards pipeline.
...
Identical to figjam-issue-cards' rasterize_cards.py -- this step has no
issue/result-specific logic at all, it just rasterizes whatever SVGs +
manifest generate_cards.py produced.
