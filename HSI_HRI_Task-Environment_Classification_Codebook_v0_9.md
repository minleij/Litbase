...
*Version 0.9  ·  Created 2026-07-07  ·  Last updated 2026-07-13  ·  Companion document to Extracted_info.docx*
...
Seven codes are currently defined in this dimension: Avoidance Task (4.1), Search Task (4.2), Engagement Task (4.3), Pursuit Task (4.4), Defend/Block Task (4.5), Monitoring/Maintenance Task (4.6), and Transport/Delivery Task (4.7). Unlike Section 3, more than one of these codes will often apply to the same article, since a single mission commonly combines several behavioral relations across its phases (e.g. search, then pursue, then engage, while separately avoiding a hazard) - see the Decision Procedure (4.8) for how to assign multiple codes and note which phase/condition each applies to.
